...
NONLINEARITIES = ["tanh", "relu", "softplus",
                  "elu", "swish", "square", "identity"]
SOLVERS = ["dopri5", "bdf", "rk4", "midpoint",
           'adams', 'explicit_adams', 'fixed_adams']
LAYERS = ["ignore", "concat", "concat_v2", "squash",
          "concatsquash", "scale", "concatscale"]


def add_args(parser):
    # model architecture options
    parser.add_argument('--model_type', type=str, default='PointNet')
    parser.add_argument('--logprob_type', type=str,
    ...
    parser.add_argument('--hyper_dims', type=str, default='256')
    ...
    parser.add_argument('--train_T', type=eval,
                        default=True, choices=[True, False])
    parser.add_argument("--nonlinearity", type=str,
                        default="tanh", choices=NONLINEARITIES)
    parser.add_argument('--use_adjoint', type=eval,
                        default=True, choices=[True, False])
    parser.add_argument('--solver', type=str,
                        default='dopri5', choices=SOLVERS)
    parser.add_argument('--atol', type=float, default=1e-5)
    parser.add_argument('--rtol', type=float, default=1e-5)
    parser.add_argument('--batch_norm', type=eval,
                        default=True, choices=[True, False])
    parser.add_argument('--sync_bn', type=eval,
    ...
    parser.add_argument('--seg_lr', type=float, default=1e-2,
                        help='Learning rate for the Adam optimizer.')
    ...
    parser.add_argument('--data_dir', type=str,
                        default='../data/', help="Path to the training data")
    ...
    parser.add_argument('--timeit', type=eval,
                        default=False, choices=[True, False])
